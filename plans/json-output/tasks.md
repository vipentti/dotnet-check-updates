...
- [x] T1 Add `--json` settings, compatibility validation, and dedicated version 1 output models.
- [x] T2 Produce deterministic JSON-mode results from representative canonical paths and unique checked files while preserving text-mode occurrences.
